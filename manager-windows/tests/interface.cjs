...
w.eval(`identity={role:'manager',name:'Robin'};session={user:{email:'manager@example.com'}};customers=[{id:'a',name:'Shalini bv',customerNumber:'SF-1',contactName:'Test',email:'test@example.com',status:'active',playerLimit:2,playersUsed:2,expiresAt:'2027-01-01',street:'Straat',houseNumber:'1',postalCode:'1234AB',city:'Rotterdam',country:'Nederland'}];players=[{id:'p',name:'Online',organizationId:'a',version:'0.3.0',firmware:'Build 123',latestVersion:'0.3.1',lastSeen:new Date().toISOString()},{id:'q',name:'Offline',organizationId:'a',version:'0.3.0',firmware:'Niet gemeld',lastSeen:null}];supportRequests=[{id:'1',organization_id:'a',ticket_number:'SFT-1',subject:'Beeld',description:'Geen beeld',priority:'normal',status:'resolved',created_at:'2026-09-13',support_request_messages:[]},{id:'2',organization_id:'a',ticket_number:'SFT-2',subject:'Oud probleem',description:'Probleem',priority:'normal',status:'resolved',archived_at:'2026-09-13',created_at:'2026-09-13',support_request_messages:[{sender_role:'manager',message:'Adapter verwisseld',created_at:'2026-09-13'}]}];activePage='overview';renderDashboard()`);
...
dom.window.close();console.log('PASS: manager layout, archive search, customer confirmation, recovery invalid code/mismatch, isolated session and cancellation.');
